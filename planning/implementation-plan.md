...
2. Bundle the supplied non-charted Jacquard 12, Jacquard 24, and Jacquarda Bastarda 9 files plus the four supplied GFS Neohellenic styles. Preserve Jacquard only for `h1`–`h6` headings and the CUMULUS wordmark, and apply GFS Neohellenic to every other text element.
