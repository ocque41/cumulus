...
const chartConfig = {
    desktop: {
        label: "Desktop",
        color: "#fbbf24", // Amber-400 (High contrast yellow/orange)
    },
    mobile: {
        label: "Mobile",
        color: "#db2777", // Pink-600 (High contrast pink)
    },
...
export function PartialLineChart() {
    ...
    return (
        <Card className="h-full">
            <CardHeader>
                <CardTitle className="flex items-center gap-2 font-mono uppercase tracking-tight text-lg">
                    Revenue Forecast
                    <Badge
                        variant="outline"
                        className="text-green-500 bg-green-500/10 border-none ml-2 font-mono"
                    >
