...
export function ClippedAreaChart() {
    ...
    useMotionValueEvent(springX, "change", (latest: number) => {
        setAxis(latest);
    });
    ...
    return (
        <Card className="h-full">
            <CardHeader>
                <CardTitle className="font-mono text-4xl flex items-center gap-2">
                    ${springY.get().toFixed(0)}
                    <Badge variant="subtle" className="font-mono text-sm">
