...
export default function AuthCodeErrorPage() {
  return (
    <main className="mx-auto flex min-h-[70vh] w-full max-w-3xl items-center justify-center px-6 py-16">
      <div className="w-full rounded-[5.5px] border border-[color:var(--muted)]/40 bg-[color:var(--glass-bg-standard)] p-8 text-center shadow-[0_24px_80px_rgba(0,0,0,0.32)]">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          <Link
            href="/login"
            className="inline-flex min-h-11 items-center justify-center rounded-full border border-[color:var(--muted)]/40 px-5 text-xs uppercase tracking-[0.14em] text-[color:var(--fg)] transition-colors hover:border-[color:var(--fg)]/60"
          >
            Back To Login
          </Link>
        </div>
